...
import { BarChart3, TrendingUp, Users, FileText, Upload, PlusCircle, Eye, Target } from "lucide-react"
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Closed Lost Analysis & Reporting Analytics</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Since implementing CLARA</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <div className="grid gap-8 md:grid-cols-2">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">TechCorp Interview Completed</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">GlobalTech Analysis Started</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">InnovateCo Report Generated</p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Most common reasons for lost deals</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
