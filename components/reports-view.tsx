...
import { FileText, Download, CalendarIcon, BarChart3, Users } from "lucide-react"
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Pre-configured report types for common analysis needs</CardDescription>
              </CardHeader>
                ...
                <div className="grid gap-3">
                  <Button variant="outline" className="justify-start h-auto p-4">
                    <div className="text-left">
                      ...
                      <div className="text-sm text-muted-foreground">Individual deal analysis with insights</div>
                    </div>
                  </Button>
                  <Button variant="outline" className="justify-start h-auto p-4">
                    <div className="text-left">
                      <div className="font-medium">Quarterly Trend Report</div>
                      <div className="text-sm text-muted-foreground">Aggregate trends and patterns</div>
                    </div>
                  </Button>
                  <Button variant="outline" className="justify-start h-auto p-4">
                    <div className="text-left">
                      <div className="font-medium">Competitive Analysis</div>
                      <div className="text-sm text-muted-foreground">Competitor comparison and positioning</div>
                    </div>
                  </Button>
                  <Button variant="outline" className="justify-start h-auto p-4">
                    <div className="text-left">
                      <div className="font-medium">Gap Analysis Report</div>
                      <div className="text-sm text-muted-foreground">Product and service improvement areas</div>
                    </div>
                  </Button>
                </div>
              </CardContent>
                ...
                <div className="space-y-2">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="competitor-a">Lost to Competitor A</SelectItem>
