    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Standardized template for requesting client feedback interviews
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Best practices for scheduling and conducting interviews
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>
                  • Response rate typically 30-40% for recent opportunities
                </li>
                <li>
                  • Higher success when account lead has strong relationship
                </li>
                <li>
                  • Best timing is 1-3 weeks after their decision announcement
                </li>
