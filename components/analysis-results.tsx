        ...
        <TabsContent value="overview" className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    34% of deals lost due to pricing being above budget or
                    uncompetitive
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    28% cited missing features or functionality
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    22% needed faster deployment than we could offer
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest insights from completed interviews
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 border border-red-200 rounded-lg bg-red-50">
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    Consistently 20-30% higher than competitors. Need flexible
                    pricing tiers.
                  </p>
                </div>
                <div className="p-4 border border-red-200 rounded-lg bg-red-50">
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    Missing advanced dashboard and real-time reporting
                    capabilities.
                  </p>
                </div>
              </CardContent>
        ...
        <TabsContent value="trends" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Win rate and key metrics over time
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-blue-700 space-y-1">
                    <li>
                      • Q4 shows improvement after implementing pricing
                      adjustments
                    </li>
                    <li>
                      • Consistent feedback on feature gaps throughout the year
                    </li>
                    <li>
                      • Support satisfaction improvements correlate with better
                      outcomes
                    </li>
                  </ul>
                </div>
