...
import { Search, Filter, Eye, Download, Calendar, DollarSign } from "lucide-react"
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Track and manage closed-lost deals and their analysis status</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage all closed-lost deals in the analysis pipeline</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex gap-4 mb-6">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Analysis In Progress">Analysis In Progress</SelectItem>
                ...
                <TableRow key={deal.id}>
                  ...
                  <TableCell>
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">{deal.industry}</div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    {deal.interviewDate ? new Date(deal.interviewDate).toLocaleDateString() : "Not scheduled"}
                  </TableCell>
                  <TableCell>
